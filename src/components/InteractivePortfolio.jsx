...
const InteractivePortfolio = () => {
  ...
  const portfolioData = [
    {
      ...
      category: "clinical",
      description: "Comprehensive patient care during clinical rotations at Pabna Sadar Hospital, focusing on compassionate nursing care and medical procedures.",
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=600&h=400&fit=crop",
      technologies: ["Patient Care", "Medical Assessment", "Medication Administration", "Documentation"],
      achievements: ["95% Patient Satisfaction", "Zero Medical Errors", "Team Leadership"],
    ...
    },
    {
      ...
      category: "training",
      description: "Advanced emergency response and first aid training program, including CPR certification and critical care procedures.",
      image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=600&h=400&fit=crop",
      technologies: ["CPR", "First Aid", "Emergency Medicine", "Critical Care"],
      achievements: ["CPR Certified", "First Aid Expert", "Emergency Response Team"],
    ...
    },
    {
      ...
      category: "community",
      description: "Led community health awareness campaigns focusing on maternal health, vaccination drives, and health education in rural areas.",
      image: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=600&h=400&fit=crop",
      technologies: ["Health Education", "Community Outreach", "Vaccination", "Maternal Care"],
      achievements: ["500+ People Reached", "Community Leader", "Health Advocate"],
    ...
    },
    {
      ...
      category: "research",
      description: "Conducted research on nursing intervention effectiveness in post-operative care, contributing to evidence-based nursing practices.",
      image: "https://images.unsplash.com/photo-1582719471384-894fbb16e074?w=600&h=400&fit=crop",
      technologies: ["Research Methodology", "Data Analysis", "Evidence-Based Practice", "Academic Writing"],
      achievements: ["Published Research", "Academic Excellence", "Innovation Award"],
    ...
    },
    {
      ...
      category: "technology",
      description: "Developed digital health solutions for patient monitoring and telemedicine consultations during COVID-19 pandemic.",
      image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=600&h=400&fit=crop",
      technologies: ["Telemedicine", "Digital Health", "Patient Monitoring", "Health Tech"],
    ...
    },
    {
      ...
      category: "clinical",
      description: "Specialized pediatric nursing care including child development assessment, family education, and pediatric emergency procedures.",
      image: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=600&h=400&fit=crop",
      technologies: ["Pediatric Care", "Child Development", "Family Education", "Pediatric Emergency"],
      achievements: ["Pediatric Certification", "Child Care Expert", "Family Favorite"],
  ...
  const categories = [
    ...
    { id: 'clinical', name: 'Clinical Work', count: portfolioData.filter(p => p.category === 'clinical').length },
    { id: 'training', name: 'Training', count: portfolioData.filter(p => p.category === 'training').length },
    { id: 'community', name: 'Community', count: portfolioData.filter(p => p.category === 'community').length },
    { id: 'research', name: 'Research', count: portfolioData.filter(p => p.category === 'research').length },
    { id: 'technology', name: 'Technology', count: portfolioData.filter(p => p.category === 'technology').length }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className={`text-center mb-16 transform transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Explore my journey in healthcare through interactive case studies, clinical experiences, and innovative projects
          </p>
        </div>

        {/* Category Filter */}
        <div className={`flex flex-wrap justify-center gap-4 mb-12 transform transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <div className={`w-12 h-12 bg-gradient-to-r ${project.glowColor} rounded-2xl flex items-center justify-center shadow-lg transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-12`}>
                        <span className="text-2xl filter drop-shadow-lg">{project.icon}</span>
                      </div>
                    </div>

                    {/* Category Badge */}
                    <div className="absolute top-4 left-4">
                      <span className={`px-3 py-1 bg-gradient-to-r ${project.gradient.replace('/20', '/80')} backdrop-blur-sm rounded-full text-white text-xs font-semibold uppercase tracking-wide`}>
                        {project.category}
                      </span>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.slice(0, 3).map((tech, idx) => (
                        <span key={idx} className="px-2 py-1 bg-white/10 text-gray-300 text-xs rounded-lg backdrop-blur-sm">
                          {tech}
                        </span>
                      ))}
          ...
          <div className="max-w-4xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-gray-900/90 to-purple-900/90 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="relative">
                ...
                />
                <div className="absolute top-4 right-4">
                  <div className={`w-16 h-16 bg-gradient-to-r ${selectedProject.glowColor} rounded-2xl flex items-center justify-center shadow-lg`}>
                    <span className="text-3xl filter drop-shadow-lg">{selectedProject.icon}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  <span className={`px-3 py-1 bg-gradient-to-r ${selectedProject.gradient.replace('/20', '/80')} rounded-full text-white text-sm font-semibold uppercase tracking-wide`}>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.technologies.map((tech, idx) => (
                      <span key={idx} className={`px-3 py-2 bg-gradient-to-r ${selectedProject.gradient} border border-white/20 text-white text-sm rounded-lg backdrop-blur-sm`}>
                        {tech}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="space-y-2">
                    {selectedProject.achievements.map((achievement, idx) => (
                      <div key={idx} className="flex items-center gap-3 text-gray-300">
                        <div className={`w-2 h-2 bg-gradient-to-r ${selectedProject.glowColor} rounded-full`} />
                        {achievement}
                      </div>
                    ))}
                  </div>
