    ...
    <div className=" bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 relative overflow-hidden py-16">
      ...
      <div className="relative z-10 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-block px-6 py-3 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 backdrop-blur-sm text-xl border border-cyan-500/30 rounded-full mb-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              {categories.map((category, index) => (
                <button
                  ...
                  className={`px-4 text-lg md:px-6 py-2 md:py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 ${
                ...
                >
                  ...
                  <div className="block md:hidden">
                    ...
                    <div className="p-4">
                      ...
                      {/* Mobile Title */}
                      <h2 className="text-3xl font-bold text-cyan-400 my-4 leading-tight group-hover:text-cyan-500 transition-colors duration-300">
                        {blog.title}
                      </h2>

                      {/* Mobile Excerpt */}
                      <p className="text-gray-300 text-xl mb-4 leading-relaxed line-clamp-2">
                        {blog.excerpt}
                      </p>
                      ...
                      <div className="flex flex-wrap gap-1 mb-4">
                        {blog.tags.slice(0, 2).map((tag, tagIndex) => (
                          <span
                            key={tagIndex}
                            className="px-2 py-1 bg-white/5 border border-white/20 rounded-full text-base text-cyan-400"
                          >
                            #{tag}
                          </span>
                        ))}
                      ...
                      <div className="flex mt-4 items-center justify-between">
                        <button
                          ...
                          className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg font-semibold text-white text-xl shadow-lg hover:shadow-cyan-500/25 transition-all duration-300"
                        >
                          Read More
                        </button>
